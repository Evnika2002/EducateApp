...
namespace EducateApp.Models
{
    public class EmailService
    {
        public async Task SendEmailAsync(string email, string subject, string message)
        {
            ...
            emailMessage.From.Add(new MailboxAddress("Администрация сайта", "matafonovaevnukapvkc2-1@mail.ru"));
            ...
            using (var client = new SmtpClient())
            {
                ...
                await client.AuthenticateAsync("matafonovaevnukapvkc2-1@mail.ru", "RrV7L84ynVBbJv8WqqLs");
